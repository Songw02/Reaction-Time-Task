// Adjusted code to only use AX, AY, BX, BY in proportions of 7:1:1:1

// Function to select weighted random stimuli based on predefined proportions
...
// Parameters to control the number of each type of trial (assuming 100 total trials for easy calculation)
const numTrials = 100;
let trials = [];
